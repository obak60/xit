...
const FAQ = () => {
    ...
    const items = [
        {
            key: '1',
            label: <h3 className="text-dark font-semibold text-base md:text-xl">01. What services do you offer?</h3>,
        ...
        {
            key: '2',
            label: <h3 className="text-dark font-semibold text-base md:text-xl">02. How do you ensure the security of the software?</h3>,
        ...
        {
            key: '3',
            label: <h3 className="text-dark font-semibold text-base md:text-xl">03. Do you provide post-launch support and maintenance?</h3>,
        ...
        {
            key: '4',
            label: <h3 className="text-dark font-semibold text-base md:text-xl">04. How long does it take to develop a software solution?</h3>,
        ...
        {
            key: '5',
            label: <h3 className="text-dark font-semibold text-base md:text-xl">05. How much does software development cost?</h3>,
        ...
        {
            key: '6',
            label: <h3 className="text-dark font-semibold text-base md:text-xl">06. Can you develop both iOS and Android apps?</h3>,
        ...
        {
            key: '7',
            label: <h3 className="text-dark font-semibold text-base md:text-xl">07. Why should we choose your company?</h3>,
        ...
        <>
            <div className="container">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    )} expandIconPosition={'end'} defaultActiveKey={1} className="bg-light dark:bg-dark" />
                </div>
            </div>
        </>
    );
