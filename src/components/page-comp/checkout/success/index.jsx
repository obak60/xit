...
const SuccessOrder = ({ successOrderData }) => {
    ...
    return (
        <div className="container">
            <div className="flex items-center justify-center pt-10 pb-28">
                <div className="bg-light dark:bg-gray-800 shadow-lg rounded-sm p-8 text-center border border-gray-200 dark:border-gray-700 max-w-lg w-full">
                    ...
                    {/* Order Details */}
                    <div className="bg-light dark:bg-gray-800 p-6 mt-6 rounded-sm shadow-md border border-gray-200 dark:border-gray-700">
                        <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Order Invoice</h3>
                        <p className="text-gray-600 dark:text-gray-300 mt-2">
                            Order ID: <span className="font-semibold">{successOrderData?.order_id || 0}</span>
                        </p>
                        <p className="text-gray-600 dark:text-gray-300">
                            Total Amount: <span className="font-semibold">৳{successOrderData?.grand_total || 0}</span>
                        </p>
                        <p className="text-gray-600 dark:text-gray-300">
                            Due Amount: <span className="font-semibold">৳{successOrderData?.due_amount || 0}</span>
                        </p>
                        <p className="text-gray-600 dark:text-gray-300 mt-2">
                            Order Date:{" "}
                        ...
                        <p className="pt-3 text-red-600 font-bold">
                            {/* Please download invoice OR take screenshot */}
